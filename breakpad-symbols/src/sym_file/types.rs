...
impl Function {
    ...
    /// given address. Line records describe locations at the innermost level
    /// of inline calls at that address.
    pub fn get_innermost_source_location(&self, addr: u64) -> Option<(u32, u32, u64)> {
        let line = self.lines.get(addr)?;
